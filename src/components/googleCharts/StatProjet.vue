<template>
    ...
    <!--    <div class="col-6">
        ...
        <div class="col-6">
            <div class="card my-2">
                <div class="card-body">
                    <h3 class="card-title fs-4">Toutes les Habilitations du projet</h3>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card my-2">
                <div class="card-body">
                    <h3 class="card-title fs-4 text-center">Nombre de KN par projet</h3>
...
export default {
    ...
    components: { ProjectPieChart, ProjectTable },
    mounted() {
