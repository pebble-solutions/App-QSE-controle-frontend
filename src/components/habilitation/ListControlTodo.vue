<template>
    ...
    <template v-if="isReady">
        ...
        <app-menu-item v-for="habilitationPersonnel in habilitationsPersonnels" :key="habilitationPersonnel.id" :href="'/habilitationPersonnel/'+habilitationPersonnel.id">
        ...
        <div class="d-grid my-2" v-if="pending.habilitationsPersonnels || isMoreAvailable">
            <button class="btn btn-outline-secondary" :disabled="pending.habilitationsPersonnels" @click.prevent="loadMore()">
                <span v-if="pending.habilitationsPersonnels"><span class="spinner-border spinner-border-sm"></span> Chargement...</span>
