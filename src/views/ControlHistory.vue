<template>
        ...
        <div v-if="!pending.control">
                ...
                <div class="list-group" v-if="listControlDone.length">
                    <div class="list-group-item list-group-item-action d-flex flex-column justify-content-between align-items-between mb-2" v-for="control in listControlDone" :key="control.id">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <span v-if="control.result_var" class="badge" :class="classNameFromSAMI(control.result_var)">{{ control.result_var}}</span>
